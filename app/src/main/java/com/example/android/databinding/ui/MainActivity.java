package com.example.android.databinding.ui;
...
import com.example.android.databinding.model.Post;
import com.example.android.databinding.model.User;
import com.example.android.databinding.utils.GridSpacingItemDecoration;
    ...
    public class MyClickHandlers {
        ...
        public boolean onProfileImageLongPressed(View view) {
            Toast.makeText(getApplicationContext(),
                    "Profile image long pressed!", Toast.LENGTH_LONG).show();
            return false;
        }
